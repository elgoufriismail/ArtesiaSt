...
| **Our Services** | 4 cards in a row (316×560), image parallax 200 | **2×2 grid** (464-wide cards, image 464×600), parallax 200, "read more" visible (Touch variant, no hover) | **1 column**, cards full width (358 × ~400 image), **no parallax** (intensity 0), Touch variant |
